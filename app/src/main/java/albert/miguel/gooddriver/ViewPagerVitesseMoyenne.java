...
public class ViewPagerVitesseMoyenne extends Fragment {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        viewPagerAdapter.addFragment(new CalculVitesseMoyenne(), "Vitesse moyenne");
        viewPagerAdapter.addFragment(new CalculTempsTrajet(), "Temps de trajet");
