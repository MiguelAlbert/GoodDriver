...
public class DailyWorkerEcheanceCarte extends Worker {
    ...
    public void sendNoti(Context context, int notiID) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            contentIntent = PendingIntent.getActivity(context, notiID, notificationIntent, PendingIntent.FLAG_UPDATE_CURRENT |PendingIntent.FLAG_IMMUTABLE);
        } else{
            contentIntent = PendingIntent.getActivity(context, notiID, notificationIntent, PendingIntent.FLAG_CANCEL_CURRENT);
        }
